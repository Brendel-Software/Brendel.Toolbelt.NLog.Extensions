...
public class TimestampedCounter {
	...
	public bool CheckExpired(TimeSpan interval, DateTimeOffset timestamp) {
	...
	/// </summary>
	public void Increment(DateTimeOffset timestamp) {
		if (StartTimestamp == DateTimeOffset.MinValue) {
